...
export const en = {
  ...
  'plugins.t3code.title': 'T3Code',
  'plugins.t3code.threads': 'Threads',
  'plugins.t3code.newThread': 'New thread',
  'plugins.t3code.threadReady': 'Thread ready. Describe what you want the agent to do.',
  'plugins.t3code.noRepository': 'Open a repository to plan agent work.',
  'plugins.t3code.noRepositoryShort': 'No repository',
  'plugins.t3code.noAiPermission': 'T3Code needs the ai.invoke permission.',
  'plugins.t3code.you': 'You',
  'plugins.t3code.agent': 'Agent',
  'plugins.t3code.prompt': 'Agent prompt',
  'plugins.t3code.promptPlaceholder': 'Describe the next step for the agent…',
  'plugins.t3code.send': 'Send',
  'plugins.t3code.sending': 'Sending…',
