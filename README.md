...
- **File view** — edit existing UTF-8 working-tree files with syntax
  ...
  counts, and keyboard navigation. A compact top-right **+** menu above search
  creates a file or folder at the repository root; fully ignored folders and
  their descendants stay muted without internal change dots.
