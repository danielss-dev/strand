...
| Signed platform distribution | Complete: macOS signed/notarized, Windows Partner Center-signed Store MSIX, Linux AppImage keyless-signed with Sigstore | Keep the three trusted distribution paths and their updater/signature checks release-green |
