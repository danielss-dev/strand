...
export const en = {
  ...
  'plugins.heroi.subtitle': 'Local agent orchestrator',
  'plugins.heroi.sidebar': 'Heroi sidebar',
  'plugins.heroi.project': 'Project',
  'plugins.heroi.sessions': 'Sessions',
  'plugins.heroi.newSession': 'New session',
  'plugins.heroi.welcome': 'Heroi inside Strand — pick an agent (Claude Code, Codex, Gemini, Aider, or Shell), plan a turn, then run it in the Work terminal against this repository.',
  'plugins.heroi.sessionReady': '{agent} session ready. Plan a turn here, or run the agent in Work.',
  'plugins.heroi.noRepository': 'Open a repository to attach this project to Heroi.',
  'plugins.heroi.noRepositoryShort': 'No repository',
  'plugins.heroi.dirty': 'dirty',
  'plugins.heroi.worktree': 'worktree',
  'plugins.heroi.noAiPermission': 'Heroi needs the ai.invoke permission for planning turns.',
  'plugins.heroi.planNeedsProvider': 'Planning turns need Claude Code or Codex. Pick one of those agents, or use Run in Work for Gemini, Aider, or Shell.',
  'plugins.heroi.you': 'You',
  'plugins.heroi.agentRole': 'Heroi',
  'plugins.heroi.system': 'System',
  'plugins.heroi.prompt': 'Agent plan prompt',
  'plugins.heroi.planPlaceholder': 'Describe the goal — Heroi will draft a plan for the selected agent…',
  'plugins.heroi.runPlaceholder': 'Use Run in Work to launch this agent in a terminal.',
  'plugins.heroi.plan': 'Plan',
  'plugins.heroi.sending': 'Planning…',
  'plugins.heroi.agent': 'Agent',
  'plugins.heroi.runInWork': 'Run in Work',
  'plugins.heroi.openProject': 'Heroi on GitHub',
  'plugins.heroi.providerReady': 'Signed in',
  'plugins.heroi.providerNeedsLogin': 'Sign-in required',
  'plugins.heroi.providerMissing': 'CLI not found',
  'plugins.heroi.bridgeHint': 'Full orchestrator: github.com/danielss-dev/heroi',
  'plugins.heroi.planMode': 'plan turn',
  'plugins.heroi.terminalMode': 'terminal launch',
  'plugins.heroi.launchedWithCommand': 'Opened Work with a new terminal for {agent}. Run `{command}` in that shell (cwd is the active repository).',
  'plugins.heroi.launchedShell': 'Opened Work with a new shell for {agent} in the active repository.',
