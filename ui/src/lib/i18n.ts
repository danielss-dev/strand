...
export const en = {
  ...
  'plugins.heroi.repoChatsOnly': 'Repository chats',
  'plugins.heroi.chatsForRepo': 'Chats for {repo}',
  'plugins.heroi.chats': 'Chats',
  'plugins.heroi.noRepoChats': 'No chats for this repository yet.',
  'plugins.heroi.deleteConversation': 'Delete conversation {title}',
  'plugins.heroi.messageCount.one': '{count} message',
  'plugins.heroi.messageCount.other': '{count} messages',
  'plugins.heroi.newConversationHint': 'Choose an agent and send the first message.',
