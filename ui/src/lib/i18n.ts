...
export const en = {
  ...
  'plugins.heroi.noRepositoryShort': 'No repository',
  'plugins.heroi.noRepositoryHint': 'Open a repository in Strand, then add Heroi to its Workbench.',
  'plugins.heroi.chatsForRepo': 'Chats for {repo}',
  'plugins.heroi.threads': 'Threads',
  'plugins.heroi.threadFilters': 'Thread filters',
  'plugins.heroi.all': 'All',
  'plugins.heroi.running': 'Running',
  'plugins.heroi.noRepoChats': 'No chats for this repository yet.',
  'plugins.heroi.noRunningThreads': 'No agent is running in this repository.',
  'plugins.heroi.time.now': 'now',
  'plugins.heroi.time.minutes': '{count}m',
  'plugins.heroi.time.hours': '{count}h',
  'plugins.heroi.time.yesterday': 'Yesterday',
  'plugins.heroi.time.days': '{count}d',
  'plugins.heroi.deleteConversation': 'Delete conversation {title}',
  'plugins.heroi.openReview': 'Open review',
  'plugins.heroi.plan': 'Plan',
  'plugins.heroi.build': 'Build',
  'plugins.heroi.fullAccess': 'Full access',
  'plugins.heroi.askAgent': 'Ask an agent to work in {repo}',
  'plugins.heroi.askAgentHint': 'Claude, Codex, and Cursor Agent run against this repository in the background.',
  'plugins.heroi.you': 'You',
  'plugins.heroi.composerLabel': 'Message the coding agent',
  'plugins.heroi.startingAgent': 'Starting {agent}',
  'plugins.heroi.stopping': 'Stopping agent',
  'plugins.heroi.stop': 'Stop agent',
  'plugins.heroi.stopped': 'Stopped.',
  'plugins.heroi.emptyReply': 'The agent completed without a text reply.',
  'plugins.heroi.state.stopped': 'Stopped',
  'plugins.heroi.state.error': 'Failed',
  'plugins.heroi.activity.done': 'done',
  'plugins.heroi.activity.stopped': 'stopped',
  'plugins.heroi.activity.error': 'failed',
  'plugins.heroi.files.label': 'Files this turn',
  'plugins.heroi.files.added': 'Added',
  'plugins.heroi.files.changed': 'Changed',
  'plugins.heroi.files.deleted': 'Deleted',
  'plugins.heroi.tools.label': 'Tool calls ({count})',
  'plugins.heroi.tools.running': '{count} running',
  'plugins.heroi.tools.failed': '{count} failed',
  'plugins.heroi.tools.done': 'done',
  'plugins.heroi.composerPlaceholder': '{mode}…  ({shortcut}+Enter to send · Shift+Tab to switch mode)',
  'plugins.heroi.attachImage': 'Attach image',
  'plugins.heroi.removeImage': 'Remove {name}',
  'plugins.heroi.imageLimit': 'Heroi accepts up to 4 images per message.',
