...
export const en = {
  ...
  'plugins.heroi.project': 'Repositories',
  'plugins.heroi.emptyRepos': 'No repositories open yet.',
  'plugins.heroi.emptyReposHint': 'Open a repository in Strand to begin.',
  ...
  'plugins.heroi.agentTabs': 'Agent tabs',
  'plugins.heroi.newTab': 'New tab',
  'plugins.heroi.closeTab': 'Close tab',
  'plugins.heroi.run': 'Run',
  'plugins.heroi.runInWork': 'Run in Work',
  'plugins.heroi.openProject': 'Heroi on GitHub',
  'plugins.heroi.selectWorkspace': 'Select a workspace to begin',
  'plugins.heroi.terminalHintCommand': 'Launch `{command}` in Strand Work against this repository or worktree.',
  'plugins.heroi.terminalHintShell': 'Open a plain shell in Strand Work for this repository.',
  'plugins.heroi.inspector': 'Heroi inspector',
  'plugins.heroi.git': 'Git',
  'plugins.heroi.files': 'Files',
  'plugins.heroi.gitEmpty': 'Select a worktree to view git changes',
  'plugins.heroi.gitClean': 'Working tree clean',
  'plugins.heroi.filesEmpty': 'No files found',
  'plugins.heroi.filesHint': 'Browse the full tree from Strand’s Files / Work surfaces. Changed files are listed under Git.',
  'plugins.heroi.openFilesInWork': 'Open Work',
